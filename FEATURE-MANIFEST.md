...
## Reconciliation — 6 September 2026 (MOD-01 the product public flag, MOD-05 the store pricing dial, MOD-04 the whole store, MOD-03 the marketplace reading that flag, and three gates found red on main) and 1 September 2026 (MK-01/02/03/04, the login doors, the size order) and 30 August 2026 (SR-07, SR-05, AC-08/09/17, AC-07/11 + PB-01) and 28–29 August 2026 (Batch S, Batch N 1–4, the Client View gaps, AC-01, Door A, ID-01)

| | |
|---|---|
| Features listed | **459** |
| Enforced and proven (✅) | **441** |
